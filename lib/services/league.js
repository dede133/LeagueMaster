...
export const getLeaguesByField = async (fieldId) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues?field_id=${fieldId}`,
      {
        method: 'GET',
        credentials: 'include',
      }
...
export const getLeaguesByUserAndField = async (fieldId) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues/user-field-leagues?field_id=${fieldId}`,
      {
        method: 'GET',
        credentials: 'include',
      }
...
export const getLeagueDetails = async (leagueId) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues/details/${leagueId}`,
      {
        method: 'GET',
        credentials: 'include',
      }
...
export const updateLeague = async (leagueId, leagueData) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues/${leagueId}/update`,
      {
        method: 'PUT',
        credentials: 'include',
        headers: {
...
export const getOwnerLeagues = async () => {
  try {
    const response = await fetch(`${API_BASE_URL}/api/leagues/owner-leagues`, {
      method: 'GET',
      credentials: 'include',
    });
...
export const getUserLeagues = async () => {
  try {
    const response = await fetch(`${API_BASE_URL}/api/leagues/user-leagues`, {
      method: 'GET',
      credentials: 'include',
    });
...
export const createTeamWithPlayers = async (leagueId, teamData) => {
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues/${leagueId}/join`,
      {
        method: 'POST',
        credentials: 'include',
        headers: {
...
export const getTeamsByLeague = async (leagueId) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues/${leagueId}/teams`,
      {
        method: 'GET',
        credentials: 'include',
      }
...
export const startLeague = async (leagueId) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues/${leagueId}/start`,
      {
        method: 'POST',
        credentials: 'include',
      }
...
export const generateLeagueLink = async (leagueId, date) => {
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues/${leagueId}/generate-links`,
      {
        method: 'POST',
        credentials: 'include',
        headers: {
...
export const getLeagueLinks = async (leagueId) => {
  ...
  try {
    const response = await fetch(
      `${API_BASE_URL}/api/leagues/${leagueId}/links`,
      {
        method: 'GET',
        credentials: 'include',
      }
